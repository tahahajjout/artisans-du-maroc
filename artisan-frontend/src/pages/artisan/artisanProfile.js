          ...
          <img
            src={
              artisan?.profile_picture
                ? imgSrc(artisan.profile_picture)
          ...
          <div className="profile-grid">
                ...
                {artisan?.status === "actif" ? (
                  <>
                    <span className="status-badge actif">
                      <span className="status-dot"></span>Actif
                    </span>
                    <p className="status-hint">
                      Votre compte est visible publiquement
                    </p>
                  </>
                ) : (
                  <>
                    <span className="status-badge en_attente">
                      <span className="status-dot"></span>En attente
                    </span>
                    <p className="status-hint">
            ...
            <div className="bio-section">
              ...
              <p className="bio-text">
                {artisan?.bio || "Aucune biographie rédigée."}
              </p>
            </div>
          </div>
        ...
        <div className="modal-overlay">
          <div className="modal-content modal-pending">
            ...
            <p className="pending-text">
              Votre compte est en cours de validation par notre équipe. Vous
              serez notifié par email dès que votre compte sera activé.
            </p>
            <button
