...
function EditProfile() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_URL}/api/artisan/private/${user.id}`)
      .then((res) => {
  ...
  const handlePasswordChange = async () => {
    ...
    if (!passwordData.current_password)
      errs.current_password = "Champ obligatoire";
    ...
    try {
      ...
      else if (msg.includes("identique"))
        setPasswordErrors({
          new_password: "Le nouveau mot de passe est identique à l'ancien",
        });
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.full_name.trim())
      newErrors.full_name = "Le nom est obligatoire";
    if (!formData.email.trim()) newErrors.email = "L'email est obligatoire";
    if (!formData.phone_number?.trim())
      newErrors.phone_number = "Le téléphone est obligatoire";
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (response.data.newImagePath)
          updatedUser.profile_picture = response.data.newImagePath;
        if (response.data.newBannerPath)
          updatedUser.banner_photo = response.data.newBannerPath;
  ...
  const currentImgDisplay = previewUrl || imgSrc(formData.profile_picture);
  const currentBannerDisplay =
    bannerPreviewUrl || imgSrc(formData.banner_photo);
        ...
        <div className="centered-form-wrapper">
          <div className="info-card edit-container">
            ...
            <form onSubmit={handleSubmit} className="product-form">
              ...
              <div className="form-row">
                ...
                <div className="form-group" style={{ flex: 1 }}>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    style={{
                      borderColor: errors.phone_number ? "#e74c3c" : "",
                    }}
                  />
                  {errors.phone_number && (
                    <span style={{ color: "#e74c3c", fontSize: "12px" }}>
              ...
              <div className="form-group file-upload-section">
                <label>🖼️ Changer la photo de bannière</label>
                {bannerPreviewUrl && (
                  <img
                ...
                />
                <small>
                  Cette image apparaît en grand sur votre profil public.
                </small>
              </div>
                  ...
                  >
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        style={{
                          borderColor: passwordErrors.new_password
                            ? "#e74c3c"
                            : "",
                        }}
                      />
