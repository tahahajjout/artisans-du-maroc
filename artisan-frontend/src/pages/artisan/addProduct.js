...
function AddProduct() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (Number(price) < 0) {
      setPriceError("Prix < 0 impossible");
      return;
    }
        ...
        <div className="artisan-card">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              type="text"
              className="art-input"
              placeholder="Ex: Tajine décoratif"
              value={title}
            ...
            >
              <div>
                ...
                <input
                  ...
                  style={{ borderColor: priceError ? "#e74c3c" : "" }}
                  required
                />
              </div>
              <div>
