   ...
   const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (response.data.success) {
            ...
            if (user.status === 'en_attente') {
                ...
                setShowPending(true); // show popup instead of navigating
                return;
            }
    ...
    return (
        <div className="login-page">
            <div className="login-card" style={{ borderTop: '5px solid #b95d2b' }}>
                <h1 className="logo-login">ARTISANS DU MAROC</h1>
                <h2 style={{ color: '#b95d2b' }}>Espace Artisan</h2>
                <p className="login-subtitle">Gérez votre vitrine, vos produits et vos avis clients.</p>
                ...
                <form onSubmit={handleSubmit} className="login-form">
                    ...
                    <button type="submit" className="login-btn">ACCÉDER À MON ESPACE</button>
                </form>
                ...
                <div className="login-footer">
                    ...
                    <p>Nouveau ici ? <Link to="/artisan_register">S'inscrire</Link></p>
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: '48px', marginBottom: '16px' }}>⏳</div>
                    <h2 style={{ color: '#b95d2b', marginBottom: '12px' }}>Compte en attente</h2>
                    <p style={{ color: '#666', lineHeight: '1.7', marginBottom: '24px' }}>
                        Votre compte n'est pas encore activé. Notre équipe est en train de valider votre inscription.
                        Vous serez notifié par email dès que votre compte sera activé.
                    </p>
                    <button
                        onClick={() => { setShowPending(false); localStorage.removeItem('user'); }}
                        style={{
                            padding: '12px 30px', background: '#b95d2b', color: 'white',
            ...
            {showBlocked && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ fontSize: '48px', marginBottom: '16px' }}>🚫</div>
                        <h2 style={{ color: '#e74c3c', marginBottom: '12px' }}>Compte bloqué</h2>
                        <p style={{ color: '#666', lineHeight: '1.7', marginBottom: '24px' }}>
